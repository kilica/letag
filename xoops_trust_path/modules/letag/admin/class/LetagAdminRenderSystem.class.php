...
define('LETAG_ADMIN_RENDER_TEMPLATE_DIRNAME','templates');
define('LETAG_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/legacy/admin/theme');    // TODO will be use other path
define('LETAG_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/legacy/admin/theme');    // TODO will be use other url

/**
 * Letag_AdminRenderSystem
**/
class Letag_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Letag_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            LETAG_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Letag_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    public static function getOverrideFileInfo(/*** string ***/ $file,/*** string ***/ $prefix = null,/*** bool ***/ $isSpDirName = false)
    {
        ...
        {
            $handler =& Letag_Utils::getXoopsHandler('module');
        ...
        switch(true)
        {
            ...
            case $isModule && file_exists(
                ...
                $ret['dirname'] = $trustDirName;
                return $ret;
            case file_exists($path = LETAG_ADMIN_RENDER_FALLBACK_PATH . '/' .$file):
                $ret['url'] = LETAG_ADMIN_RENDER_FALLBACK_URL . '/' . $file;
                $ret['path'] = $path;
                $ret['theme'] = null;
                $ret['dirname'] = null;
                return $ret;
    ...
    **/
    ...
    {
        $info = Letag_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return LETAG_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Letag_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
