...
class Letag_AssetPreloadBase extends XCube_ActionFilter
{
    ...
    public function preBlockFilter()
    {
        ...
        $tagFile = version_compare(LEGACY_BASE_VERSION, '2.2.3.0', '>=') ? LETAG_TRUST_PATH . '/class/TagDelegateFunctions.class.php' : LETAG_TRUST_PATH . '/class/TagDelegateOldFunctions.class.php';
        $this->mRoot->mDelegateManager->add('Legacy_Tag.'.$this->mDirname.'.SetTags','Letag_TagDelegate::setTags', $tagFile);
        $this->mRoot->mDelegateManager->add('Legacy_Tag.'.$this->mDirname.'.GetTags','Letag_TagDelegate::getTags', $tagFile);
        $this->mRoot->mDelegateManager->add('Legacy_Tag.'.$this->mDirname.'.GetTagCloudSrc','Letag_TagDelegate::getTagCloudSrc', $tagFile);
        $this->mRoot->mDelegateManager->add('Legacy_Tag.'.$this->mDirname.'.GetDataIdListByTags','Letag_TagDelegate::getDataIdListByTags', $tagFile);
