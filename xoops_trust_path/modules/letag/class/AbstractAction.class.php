...
/**
 * Letag_AbstractAction
**/
abstract class Letag_AbstractAction
{
	public /*** XCube_Root ***/ $mRoot = null;

	public /*** Letag_Module ***/ $mModule = null;

	public /*** Letag_AssetManager ***/ $mAsset = null;
