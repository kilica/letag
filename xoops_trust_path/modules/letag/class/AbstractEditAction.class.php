...
/**
 * Letag_AbstractEditAction
**/
abstract class Letag_AbstractEditAction extends Letag_AbstractAction
{
	...
	**/
	public function execute()
	{
		...
		{
			return LETAG_FRAME_VIEW_CANCEL;
		}
	...
	**/
	protected function _saveImage(/*** string ***/ $dataname, /*** string ***/ $title, /*** string **/ $filePath, /*** int ***/ $num=1)
	{
		...
		$imageObjs = array();
		XCube_DelegateUtils::call('Legacy_Image.GetImageObjects', new XCube_Ref($imageObjs), $this->mAsset->mDirname, $dataname, $this->mObject->get($primaryKey), $num);
